on exitFrame
  ...
  if soundBusy(1) then
    if value(item 1 of inexits) > 5 then
      ...
      pat = 20
      rin = 21
      if the locH of sprite 30 > 337 then
        hezzz = "left"
      else
        hezzz = "right"
      end if
      ...
      pat = 19
      rin = 18
      if the locH of sprite 30 > 60 then
        hezzz = "left"
      else
        hezzz = "right"
      end if
    ...
    if who contains "pat" then
      ...
      if who contains "rin" then
        ...
        if who contains "pajos" then
          ...
          set the locV of sprite 30 to egozv
          set the locH of sprite 30 to egozh
          set the memberNum of sprite pat to the number of member (xxx & "patlop1") of castLib "wonder"
          set the memberNum of sprite rin to the number of member (xxx & "rinlop2") of castLib "wonder"
        else
