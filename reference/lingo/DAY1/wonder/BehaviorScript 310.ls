on mouseUp
  global soundspath, effectspath, movienamekeeper, stopornot, meetings
  if (sprite(30).visible = 1) and (item 1 of meetings <> "murder1") then
    if the freeBlock > (12 * 1024) then
