on exitFrame
  ...
  talkproc("d", "tof-ans", "roomcgo")
  if soundBusy(1) then
    xxx = "room"
    puppetSprite(19, 1)
    rin = 19
    if the locH of sprite 30 > (the locH of sprite 19 + 10) then
      hezzz = "left"
    else
      hezzz = "right"
    end if
    who = item usfultalking of line usfulline of field "tof-ans" of castLib "master"
