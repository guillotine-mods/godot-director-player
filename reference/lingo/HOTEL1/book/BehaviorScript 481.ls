on mouseUp
  ...
  updateStage()
  put "found" into item 15 of wreck
  x = "continue"
  repeat with i = 1 to the number of lines in field "objectsfield" of castLib "master"
    if (line i of field "objectsfield" of castLib "master" = "empty") and (x = "continue") then
      put "shrlok" into line i of field "objectsfield" of castLib "master"
      x = "stop"
    end if
  end repeat
  put "done" into item 1 of line 3 of field "Dprocess" of castLib "master"
  ...
  displayobject()
  sound playFile 1, soundspath & "pfshrlok.aif"
end
