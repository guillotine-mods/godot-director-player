on exitFrame
  ...
  repeat with i = 1 to the number of lines in field "objectsfield" of castLib "master"
    if (line i of field "objectsfield" of castLib "master" = "empty") and (x = "continue") then
      put "hair" into line i of field "objectsfield" of castLib "master"
      x = "stop"
    end if
  end repeat
  put "done" into item 1 of line 5 of field "Dprocess" of castLib "master"
  ...
  displayobject()
  sound stop 2
  sound playFile 1, soundspath & "mirolo6.aif"
end
