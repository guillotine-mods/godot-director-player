on mouseUp
  ...
  sprite(21).visible = 0
  updateStage()
  put "found" into item 11 of wreck
  x = "continue"
  repeat with i = 1 to the number of lines in field "objectsfield" of castLib "master"
    if (line i of field "objectsfield" of castLib "master" = "empty") and (x = "continue") then
      put "shoes" into line i of field "objectsfield" of castLib "master"
      x = "stop"
    end if
  end repeat
  put "done" into item 3 of line 3 of field "Dprocess" of castLib "master"
  ...
  displayobject()
  sound stop 2
  sound playFile 1, soundspath & "pfshoes.aif"
end
