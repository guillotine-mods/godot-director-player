on walkonby2
  ...
  if (the locH of sprite 30 - 10) > egozh then
    set the memberNum of sprite 30 to the number of member ("subleft" & "1") of castLib 1
    whatodo = "walktime"
    put "notok" into item 1 of stopornot
  else
    if (the locH of sprite 30 + 10) < egozh then
      set the memberNum of sprite 30 to the number of member ("subright" & "1") of castLib 1
      whatodo = "walktime"
      put "notok" into item 1 of stopornot
    end if
  end if
