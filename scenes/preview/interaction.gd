...
##
## The reference does not agree about the hidden half -- `channel.cpp:698` reaches
## the constraint through `getRollOverBbox()`, which is `getBbox()`, and never
## consults `_visible`. Changing it here was tried and came back out with the rest
## of that change; `director_preview.lingo_sprite_rect` has the measurement.
##
